...
--[[
    ...
    Note:   Nothing is being set up at this stage, as such, the order of downloads do not matter.
            I prefer this 1-layer-style to package listing, to make it easier to read, but you must include dependencies.
]]
require('lazy').setup({
  --[[Basic Assistance]]
